...
namespace getArgs
{
    class Program
    {
        ...
        {
            Console.WriteLine("[-h, /h] [-help, /help]");
            Console.WriteLine("Displays this help\n");
            Console.WriteLine("[-b, /b] [-backup, /backup]");
            ...
            Console.WriteLine("[-d, /d] [-download, /download]");
        ...
        internal static void Backup(string arg1, string arg2)
        {
            ...
            if (arg2 != "-force" || arg2 != "/force" || arg2 != "-f" || arg2 != "/f")
